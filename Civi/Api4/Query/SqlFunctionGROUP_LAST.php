...
/**
 * Sql function returns the last item in a GROUP_CONCAT set (per the ORDER_BY param)
 * @since 5.69
 */
class SqlFunctionGROUP_LAST extends SqlFunction {
  ...
  public static function getDescription(): string {
    return ts('Last value in the grouping.');
  }
